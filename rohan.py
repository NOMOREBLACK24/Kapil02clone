...
# Bot configuration
BOT_USERNAME = "@Itskapilyadav0001Bot"
bot = telebot.TeleBot('7753887004:AAEI1cyCo3waGLMIS1rw3zo0_vzTrAKhBHA')
ADMIN_IDS = {"5968988297", "6114033856"}
CHANNEL_USERNAME = "@KAPILYADAVFREESERVICE"
FEEDBACK_CHANNEL = "@ITSKAPILYADAVBACKUP"
PAID_CHANNEL = "@KAPILYADAVFREESERVICE"
CONTACT_ADMINS = ["@ItsKapilYadav"]
...
🔥 Join @KAPILYADAVFREESERVICE & @KAPILYADAVFREESERVICE to use!
💎 +1 attack per invite to @KAPILYADAVFREESERVICE after limit or buy unlimited from @ITSKAPILYADAV
"""
